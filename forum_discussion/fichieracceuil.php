...
<head>
	...
	<title>FICHIERS-CATEGORIES</title>
</head>
<body>
<div id="block_page">
	...
	<div id="corps">
				...
				<div align="center"><h3>LISTES DES CATEGORIES DE FICHIERS</h3></div>
		...
		<?php
				while($categ = $reqcateg->fetch())
				{
					...
					<tr>
						<td colspan="3"><a href="telechargement.php?cat=<?php echo $categ['id_Cat'];  ?>"><h3><?php echo $categ['libelle'];  ?></h3></a></td>
					</tr>
					<?php
				}
				?>
