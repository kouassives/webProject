...
<div id="block_page">
	...
	<div id="corps">
			...
			<table cellspacing="10">
				<caption><h2>BIEN MAINENANT</h2></caption>
					<tr>
					<td  align=top> <p>Categorie: DEVELOPPEMENT</p></td>
					<td>Mode
Explication
r
...
a+
Ouvre le fichier en lecture et écriture. Si le fichier &amp; n'existe pas, il est créé automatiquement. Attention : le répertoire doit avoir un CHMOD à 777 dans ce cas ! À noter que si le fichier existe déjà, le texte sera rajouté à la fin.</td>
					</tr>
			</table>
