...
<div id="block_page">
	...
	<div id="corps">
			...
			<table cellspacing="10">
					...
					<td> jkofoklckdlcll c jjjjjjzkkkkkk  kkkkkkkkkkkkkk kkkkkkkkkkkkkk  kkkkkkkkkkkkkk kkkkkkkkkkkkkk   kkkkkkkkkkkkkkkkk  kkkkkkkkkkkkkk  kkkkkkkkkkkkkk  kkkkkkkkkkkkkk  kkkkkkkkkkkkkk kkkkkkkkkkkk   </td>
					</tr>
					<!-- ON VA ALLER PRENDRE AUSSI LES REPONSE AUX SUJET -->
					<?php
					$reponse = $bdd->query("SELECT * FROM reponse WHERE id_Sujet=52 ORDER BY id_Rep DESC;");
						$i=0;
