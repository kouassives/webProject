...
if (isset($_POST['btrepondre']) )
{
	...
	if (!empty($_POST['reponse_sujet']))
	{
		...
		$reqrepondre -> execute(array($reponse_sujet,$dateheure,54));
...
<div id="block_page">
	...
	<div id="corps">
			...
			<table cellspacing="10">
					<tr>
						<td colspan=2 align=center><h2>COMME DAB</h2></td>
					</tr>
					<tr>
					<td  Valign=top> <p>Categorie: TELECOMMUNICATION</p></td>
					<td> LJIANNEDJZ KJIA NN EDJZ LJIANNEDJZ KJIA NN EDJZ LJIANNEDJZ KJIA NN EDJZ LJIANNEDJZ KJIA NN EDJZ LJIANNEDJZ KJIA NN EDJZ LJIANNEDJZ KJIA NN EDJZ LJIANNEDJZ KJIA NN EDJZ LJIANNEDJZ KJIA NN EDJZ LJIANNEDJZ KJIA NN EDJZ LJIANNEDJZ KJIA NN EDJZ LJIANNEDJZ KJIA NN EDJZ LJIANNEDJZ KJIA NN EDJZ LJIANNEDJZ KJIA NN EDJZ LJIANNEDJZ KJIA NN EDJZ LJIANNEDJZ KJIA NN EDJZ LJIANNEDJZ KJIA NN EDJZ LJIANNEDJZ KJIA NN EDJZ LJIANNEDJZ KJIA NN EDJZ LJIANNEDJZ KJIA NN EDJZ LJIANNEDJZ KJIA NN EDJZ</td>
					</tr>
					<!-- ON VA ALLER PRENDRE AUSSI LES REPONSE AUX SUJET -->
					<?php
					$reponse = $bdd->query("SELECT * FROM reponse WHERE id_Sujet=54 ORDER BY id_Rep ASC;");
						$i=0;
					...
					<!-- ON VA DONNERLA POSSIBILITE DE REPONDRE AUX SUJETS-->
						<form ACTION=""  METHOD="POST">
							<tr>
								<td></td><td  align="center"><TEXTAREA placeholder="Votre reponse"  rows=5 cols=30 name="reponse_sujet" id="reponse_sujet" class="btrepondreacacher" ><?php if(isset($reponse_sujet)) {echo $reponse_sujet;} ?></TEXTAREA></td>
							</tr>
							<tr>
