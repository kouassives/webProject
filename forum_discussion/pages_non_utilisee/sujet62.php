...
if (isset($_POST['btrepondre']) )
{
	...
	if (!empty($_POST['reponse_sujet']))
	{
		...
		$reqrepondre -> execute(array($reponse_sujet,$dateheure,62));
...
<div id="block_page">
	...
	<div id="corps">
			...
			<table cellspacing="10">
					<tr>
						<td colspan=2 align=center><h2>GLOIRE</h2></td>
					</tr>
					<tr>
					...
					<?php
					$reponse = $bdd->query("SELECT * FROM reponse WHERE id_Sujet=62 ORDER BY id_Rep ASC;");
						$i=0;
