...
if (isset($_POST['btrepondre']) )
{
	...
	if (!empty($_POST['reponse_sujet']))
	{
		...
		$reqrepondre -> execute(array($reponse_sujet,$dateheure,55));
...
<div id="block_page">
	...
	<div id="corps">
			...
			<table cellspacing="10">
					<tr>
						<td colspan=2 align=center><h2>ZOZOR</h2></td>
					</tr>
					<tr>
					<td  Valign=top> <p>Categorie: DEVELOPPEMENT</p></td>
					<td>ZOR EST UN LA MASCOTTE DE OPENCLASSROOM ZOR EST UN LA MASCOTTE DE OPENCLASSROOM ZOR EST UN LA MASCOTTE DE OPENCLASSROOM ZOR EST UN LA MASCOTTE DE OPENCLASSROOM ZOR EST UN LA MASCOTTE DE OPENCLASSROOM </td>
					</tr>
					<!-- ON VA ALLER PRENDRE AUSSI LES REPONSE AUX SUJET -->
					<?php
					$reponse = $bdd->query("SELECT * FROM reponse WHERE id_Sujet=55 ORDER BY id_Rep ASC;");
						$i=0;
						...
						{	
							...
							?>
								<tr>
									<td ALIGN=right><?php echo '<p>Reponse de l\'utilisateur '.$_SESSION['pseudo'].' :' ;?></td>
