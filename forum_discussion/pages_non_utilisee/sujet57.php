...
if (isset($_POST['btrepondre']) )
{
	...
	if (!empty($_POST['reponse_sujet']))
	{
		...
		$reqrepondre -> execute(array($reponse_sujet,$dateheure,57));
...
<div id="block_page">
	...
	<div id="corps">
			...
			<table cellspacing="10">
					<tr>
						<td colspan=2 align=center><h2>pipi</h2></td>
					</tr>
					<tr>
					...
					<?php
					$reponse = $bdd->query("SELECT * FROM reponse WHERE id_Sujet=57 ORDER BY id_Rep ASC;");
						$i=0;
						...
						{	
							...
							?>
								<tr>
									<td ALIGN=right>Reponse de l'utilisateur  : </td>
